...
snReply = {}
connectIP = '';
tokenfile = './SMtoken.txt' # Set to writable path, file will be created if not exists.
...
def getSMToken(connectIP):
    ...
    if SMtoken == "":
        ...
        while not connected:
            ...
            print("Please authorize on Touchscreen. Waiting 20 seconds")
            time.sleep(10)
            if "Failed" in r.text:
                print(r.text)
